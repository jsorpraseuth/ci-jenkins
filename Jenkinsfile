    ...
    stages {
        ...
        stage('Checkout Codebase') {
            steps {
                ...
                [[credentialsId: 'github-ssh-key', url: 'git@github.com:jsorpraseuth/ci-jenkins.git']]
            }
        }
        ...
        stage('Build') {
            steps {
                sh 'mkdir lib'
                sh 'cd lib/ : wget https://repol.maven.org/maven2/org/junit/platform/junit-platform-console-standalone-1.7.0-all.jar'
